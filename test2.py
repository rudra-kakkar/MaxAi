...
#         # You can now send this `full_answer` further as needed
#         # Example: send it to another API or save it in a file
#         # Further logic for sending the full_answer can go here.
#     else:
